...
/**
 * @file
 * Health check for Drupal 8 sites, original from PNX.
 *
 * The code was originally released by PNX here.
 * https://raw.githubusercontent.com/previousnext/containers/master/php-apache/liveness/d8.php.
 */

// Reduce the checks as much as possible if this file is present.
$skip = realpath('/etc/liveness.skip');
...
chdir('/code/web');
$autoloader = require_once '/code/vendor/autoload.php';
...
/**
 * Connect to the data and do a simple select.
 */
...
// Exit, note the shutdown function registered at the top of the file.
exit();
